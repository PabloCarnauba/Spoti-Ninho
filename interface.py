...
GO_BACK_IMAGE_PATH = 'avaliação-ninho/Spoti-Ninho/Images/back.png'
GO_FORWARD_IMAGE_PATH = 'avaliação-ninho/Spoti-Ninho/Images/next.png'
PLAY_SONG_IMAGE_PATH = 'avaliação-ninho/Spoti-Ninho/Images/play_button.png'
PAUSE_SONG_IMAGE_PATH = 'avaliação-ninho/Spoti-Ninho/Images/pause.png'
DEFAULT_ALBUM_COVER_IMAGE_PATH = 'avaliação-ninho/Spoti-Ninho/Images/pilot.png'
